...
export const RIDER_NAV: DossierLink[] = [
  ...
  { id: "leddic", name: "レディック", href: "/riders/leddic", assets: ["/civilian-leddic.jpeg", "/civilian-naikami-chigiri.jpeg", "/rider-leddic-ishihen.jpeg", "/rider-leddic-rekka.jpeg"], kicker: "RIDER 05" },
