...
const SITE_ANNOUNCEMENTS = [
  {
    ...
    body:
      "ゼウスの超自己進化、レックスの絶対秩序、そして月城悠真の意思を一つの共鳴へ束ね、エクスプリームが切り開いた無制限出力を実効攻撃へ変換。標準状態からエクスプリーム・ウルトラを上回る、サーガシステムの次世代到達点です。ヴィンクルムサーガと比較して650%以上の反応速度と、エクスプリームサーガと比較して最大900%高い機動力を発揮。サーガシステムのウルトラハイエンドモデルに相応しい性能を発揮します。",
    note:
