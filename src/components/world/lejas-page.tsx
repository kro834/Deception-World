    ...
    <main className="manager-page" style={{ ["--manager-accent" as string]: "#78b69b", ["--manager-accent-soft" as string]: "#d7ab51" }}>
      ...
      <section className="manager-dossier" aria-label="レジャスの人物資料">
        ...
        <div className="manager-sections">
          ...
          <article className="manager-copy-section">
            ...
            <div className="manager-copy-body">
              <p>
                常に穏やかで、上談を交えて話す紳士的な人物。侮辱されても笑顔を崩さず、明確な嘘をほとんど口にしない。情報の順番、主語、前提、時系列を調整し、正しい情報だけを受け取った相手が自分の思考で誤るよう導く。
              </p>
            </div>
          </article>
          <article className="manager-copy-section">
      ...
      <FormPickup
        rider={{
          ...
          finishers: [
            { name: "FALS CRITICAL STRIKE", body: "白黒区画を踊躍して連続蹴撃を放ち、最も損害の大きい一撃だけを現実へ確定する。" },
