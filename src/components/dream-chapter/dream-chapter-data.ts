export const DREAM_POSTERS = [
  ...
  {
    src: "/dream-chapter-poster-09.jpeg",
    width: 1024,
    height: 1280,
    position: "50% 50%",
    fit: "contain",
    alt: "虹色の結晶に囲まれ、逆さの姿勢で構える黒金の戦士",
  },
  {
    src: "/dream-chapter-poster-10.jpeg",
    width: 1280,
    height: 720,
    position: "50% 50%",
    fit: "contain",
    alt: "金色の光が走る空間で、青と赤の刀身を構える黒金の戦士",
  },
  {
    src: "/dream-chapter-poster-11.jpeg",
    width: 1280,
    height: 960,
    position: "50% 50%",
    fit: "contain",
    alt: "竹林の中で長い銃身から青い光を放つ銀と青の戦士",
  },
  {
    src: "/dream-chapter-poster-12.jpeg",
    width: 1254,
    height: 1254,
    position: "50% 50%",
    fit: "contain",
    alt: "火花を散らし、黒金の戦士と赤黒の戦士が刃を交える場面",
  },
  {
    src: "/dream-chapter-poster-13.jpeg",
    width: 1280,
    height: 853,
    position: "50% 50%",
    fit: "contain",
    alt: "青く照らされた培養槽の前に、武装した戦士たちが並ぶ施設",
  },
  {
    src: "/dream-chapter-poster-14.jpeg",
    width: 1280,
    height: 723,
    position: "50% 50%",
    fit: "contain",
    alt: "雪に覆われた和風の建物の前に立つ黒金の戦士",
  },
  {
    src: "/dream-chapter-poster-15.jpeg",
    width: 1280,
    height: 720,
    position: "50% 50%",
    fit: "contain",
    alt: "淡い色の部屋の扉の向こうに、赤い空と無数の顔が広がる悪夢の情景",
  },
] as const;
...
export const DREAM_CASES = [
  {
    ...
    title: "交わる",
    reading: "INTERSECT",
    lead: "悪夢に閉ざされた世界で、三人の運命が動き出す。",
    paragraphs: [
      "廃墟と化した碧栄を舞う紫の蝶が、人々を深い悪夢へと誘っていく。自らに仕向けられた悪夢を退けたシエルは、ベルベットルームで、悪夢を資源として現実へ干渉させる試みを知らされる。世界を侵食する脅威に抗うために示されたのは、さらなる力ではなく、同じ悪夢に立ち向かう者たちとの繋がりだった。",
      "倒れていた慶弥の夢へ足を踏み入れたシエルを待っていたのは、幻想郷の東風谷邸を襲うナイトメアだった。家族を守ろうとする慶弥と共に戦い、人里の探偵を名乗る怪作とも出会ったことで、三人の道はひとつに交わっていく。だが、ドルミネンスの追撃はすぐそこまで迫っていた。怪作が開いた白い扉へ、生き延びるために三人は飛び込む。",
    ],
  },
  {
    no: "1",
    title: "開く",
    reading: "OPEN",
    lead: "扉の向こうで、失われなかった日常が彼らを待つ。",
    paragraphs: [
      "白い扉の先に広がっていたのは、怪作の心が形を取った、壊れることなく日々の営みを残す幻想郷だった。人里を満たす穏やかな暮らしのなかで、慶弥は自分が知る故郷とは異なる気配を感じ取る。ここは夢なのか、それとも現実なのか。三人は曖昧な境界を確かめながら、この地に息づく者たちと向き合っていく。",
      "追撃を逃れても、悪夢そのものから逃れたわけではない。シエルの深層では、拒絶の悪夢・マキャベルが、仲間を失うかもしれない光景を映しながら彼の心を揺さぶり続ける。慶弥の傍らで目を覚ましたシエルは、悪夢の奥に残されたものを抱えたまま朝を迎える。その胸の奥で、最後の扉はまだ開かれていなかった。",
    ],
  },
  {
    no: "2",
    title: "開ける",
    reading: "UNLOCK",
    lead: "広がる異変を前に、幻想郷がそれぞれの答えを選び始める。",
    paragraphs: [
      "射命丸文の号外によって、人里を襲った装甲戦士たちの存在は幻想郷全土へ知れ渡る。シエルは博麗神社を訪れ、ドルミネンスとナイトメア、そして怪作が狙われている事情を霊夢に明かす。霊夢は無条件に仲間となるのではなく、幻想郷の均衡を守る博麗の巫女として、彼女自身の判断で異変へ動き始める。",
      "その頃、慶弥は傷ついた人里で復旧作業と炊き出しに力を貸し、やがて守矢神社で、別の世界の早苗・神奈子・諏訪子と対面する。疑念と警戒に隔てられていたシエルたちと幻想郷の住人のあいだに、少しずつ新たな関係が芽生えていく。その一方で、彼らを取り巻く悪夢との対峙は、なお終わっていなかった。",
    ],
  },
  {
    no: "3",
    title: "明ける",
    reading: "DAWN",
    lead: "迫る侵攻に抗うため、幻想郷の各地で戦いが始まる。",
    paragraphs: [
      "博麗神社を襲うドルミネンス軍の前に、ディルクルムサーガとなったシエルが立ちはだかる。紫が境界の力で毒霧を退ける一方、戦火は迷いの竹林、魔法の森、白玉楼へと拡大。ひとつの異変は幾つもの戦線へ姿を変え、幻想郷の住人たちは、それぞれが守るべき場所のために立ち上がる。",
      "魔理沙たちは魔法の森で敵を迎え撃ち、妖夢は白玉楼と幽々子を守るため、再び刃を取る。博麗神社では『拒絶』が、失われかけた命を生へと引き戻す力としても姿を現す。だが、夜明けはいまだ遠い。危機は地獄や天界にまで及び、幻想郷を巡る戦いはさらに激しさを増していく。",
    ],
  },
  {
    no: "4",
    title: "来たる",
    reading: "ARRIVAL",
    lead: "仲間が次々と倒れ、絶望が迫り来るなかで、かけがえのない仲間が奪われる。",
    paragraphs: [
      "永遠亭で眠りについたシエルは、再びベルベットルームへ導かれる。そこで待つヴァルトマンは、すべてを一人で背負おうとする道の先に、破滅があると警告する。たとえ夢の中であっても、そこで感じた痛みも、守ろうとした想いも偽物ではない。その言葉を胸に、シエルは怪作と向き合う。だが目覚めた先の幻想郷では、共に戦ってきた仲間たちが一人、また一人と命を落としていく。守ると誓った者を守れないまま、絶望は静かに、確実に迫り来る。",
      "やがて戦いの舞台は旧地獄へ移り、霊夢、紫、魔理沙たちも激戦へ身を投じていく。倒れていく仲間の数だけ、シエルの背負うものは重くなる。しかし、ロードナイト側は混戦のさなかに怪作を連れ去り、そのまま位相を離脱する。敵の目的を阻むことができず、仲間の死を止められず、かけがえのない仲間まで奪われたシエルたち。深い喪失と絶望を抱えたまま、それでも彼らは怪作を取り戻すための道を探し始める。",
    ],
  },
  {
    no: "5",
    title: "叛く",
    reading: "REVOLT",
    lead: "帰る場所と交わした約束が、再び進むための力になる。",
    paragraphs: [
      "永遠亭で傷を癒やし、これまでに得た情報を確かめ合った仲間たちは、紅魔館、守矢神社、人里へと戻り、来たる戦いへの準備を進める。敵の全容はいまだ見えず、怪作も奪われたまま。それでもシエルは立ち止まらない。次こそは必ず、怪作を連れて帰るという決意を胸に刻む。",
      "それぞれが帰る場所を確かめ、共に戦う理由を見つめ直していく夜。眠りについたシエル、慶弥、夕夏は、再びベルベットルームへ導かれる。青い部屋で何が告げられるのか。記録はこの場面まで続いており、怪作奪還と異変の行方は、まだ明かされていない。",
    ],
  },
] as const;

export const DREAM_STORY_CROSSINGS = [
  {
    name: "博麗神社",
    role: "異変と向き合う場所",
    body: "シエルから事情を聞いた霊夢は、幻想郷の均衡を守る立場から異変へ向き合う。警戒を残しながらも寝床を貸し、やがて神社そのものがドルミネンスとの戦場となる。",
  },
  {
    name: "守矢神社",
    role: "家族と世界を見つめ直す場所",
    body: "人里の復旧を助けた慶弥が訪れ、別の世界の早苗・神奈子・諏訪子と接触する場所。戦いの後には夕夏と共に戻り、食事や休息を通して、次の一日に備える。",
  },
  {
    name: "永遠亭",
    role: "傷を癒やし、再び集う場所",
    body: "迷いの竹林での戦いを経て、傷ついた者たちが治療を受け、状況を確かめ合う拠点となる。ここで交わされた話し合いから、各地へ戻った仲間たちの準備が始まる。",
  },
] as const;
