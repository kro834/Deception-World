...
export const DREAM_CASES = [
  ...
  },
  {
    ...
    title: "来たる",
    reading: "ARRIVAL",
    lead: "すべてを背負おうとするシエルの前で、かけがえのない仲間が奪われる。",
    paragraphs: [
      "永遠亭で眠りについたシエルは、再びベルベットルームへ導かれる。そこで待つヴァルトマンは、すべてを一人で背負おうとする道の先に、破滅があると警告する。たとえ夢の中であっても、そこで感じた痛みも、守ろうとした想いも偽物ではない。その言葉を胸に、シエルは怪作と向き合う。",
      "やがて戦いの舞台は旧地獄へ移り、霊夢、紫、魔理沙たちも激戦へ身を投じていく。しかし、ロードナイト側は混戦のさなかに怪作を連れ去り、そのまま位相を離脱する。敵の目的を阻むことができず、かけがえのない仲間を奪われたシエルたち。喪失を抱えたまま、それでも彼らは怪作を取り戻すための道を探し始める。",
    ],
  },
  {
    no: "5",
